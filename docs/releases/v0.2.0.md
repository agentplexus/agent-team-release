...
2. **Symlink**: `ln -sf $(which release-agent-team) .git/hooks/pre-push`
...
- [Full Changelog](https://github.com/agentplexus/release-agent-team/blob/main/CHANGELOG.md)
- [README](https://github.com/agentplexus/release-agent-team/blob/main/README.md)
- [GitHub Repository](https://github.com/agentplexus/release-agent-team)
